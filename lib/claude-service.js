...
2. RESUMO (15-20 linhas, ~300-500 palavras)
   - Análise detalhada do artigo
   - Contexto e background do tema
   - Principais insights e dados do artigo
   - Por que importa para empresas brasileiras e latino-americanas
   - Tendências e padrões que você identifica
   - Seja generoso com espaço: este campo agora comporta muito mais conteúdo
   - Mantenha tom consultivo e informativo

3. PERSPECTIVA VIRTUS MIRAI (25-35 linhas, ~800-1200 palavras)
   - Como Virtus Mirai veria esta situação/problema (perspectiva estratégica)
   - Qual seria nossa recomendação ou insight estruturado
   - Integre insights de Hercules E/OU Wilson conforme relevante ao tema
   - Relate à metodologia Virtus Mirai (diagnóstico, estratégia, execução, transformação)
   - Exemplos de casos que vimos em clientes (genéricos, sem nomes)
   - Armadilhas comuns que as empresas caem
   - Oportunidades que emergem deste cenário
   - Próximos passos que recomendaríamos
   - Tom: Profissional consultivo, inteligente, sem solenidade, provocador quando apropriado
   - Este é o CORE do post: use todo o espaço disponível para agregar valor
...
FORMATO EXATO (JSON):
{
  ...
  "summary": "Texto do resumo em 300-500 palavras",
  "comment": "Texto da perspectiva Virtus Mirai (800-1200 palavras)",
