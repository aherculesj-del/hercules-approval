...
const testEmailContent = `// app/api/test/send-approval-email/route.js
...
const dir = path.join(__dirname, 'app/api/test/send-approval-email');
if (!fs.existsSync(dir)) {
  fs.mkdirSync(dir, { recursive: true });
}

fs.writeFileSync(path.join(dir, 'route.js'), testEmailContent, 'utf8');
console.log('✅ app/api/test/send-approval-email/route.js criado!');
console.log('');
console.log('Para testar:');
console.log('1. Faça push do arquivo para GitHub');
console.log('2. Aguarde Vercel fazer deploy');
console.log('3. Acesse: https://hercules-approval.vercel.app/api/test/send-approval-email');
console.log('4. Um email será enviado para você');
console.log('5. Clique no link do email para testar o dashboard');
